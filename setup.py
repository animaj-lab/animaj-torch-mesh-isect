...
# Set CUDA_SAMPLES_INC
os.environ["CUDA_SAMPLES_INC"] = os.path.join(here, "cuda-samples")
...
setup(
    ...
    extras_require={"render": render_reqs, "all": render_reqs},
